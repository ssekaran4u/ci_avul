            ...
            <section class="col-md-7 col-md-offset-2 sblock">
                    ...
                    <form method="post" class="pt-1">
                        <div class="form-group">
                            <input class="form-control lg" placeholder="Username" name="username" type="text"  value="<?php echo $inputs ? $inputs['username'] : htmlentities($user['username']); ?>" maxlength="32">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input class="form-control lg" placeholder="Email" name="email" type="email"  value="<?php echo $inputs ? $inputs['email'] : htmlentities($user['email']); ?>" maxlength="254">
                        </div>
                        <div class="form-group">
                    ...
                    <?php else: ?>
                    <p class="alert alert-success">Congratulations! Your new account has been successfully created!</p>
                    <?php endif; ?>
                </section>
        </div>
    </div>
